...
const DeleteHotel = observer(({ isOpen, onClose, data, getData }: any) => {
  const {
    hotelStore: { deleteHotel },
    ...
    deleteHotel(data)
      .then((response: any) => {
        openNotification({
          ...
          message: response?.message || "Hotel deleted",
          type: "success",
        });
        getData();
        onClose();
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      <ModalContent>
        ...
        <ModalCloseButton />
        <ModalBody>
          <Text>Are you sure you want to delete this hotel? This action cannot be undone.</Text>
        </ModalBody>
        <ModalFooter>
