...
import { generateHotelInitialValues } from "./utils/functions";
import { readFileAsBase64 } from "../../../config/utils/utils";
import { getStatusType } from "../../../config/utils/function";

const EditHotel = observer(({ getData, hotel, close }: any) => {
  const {
    auth: { openNotification },
    hotelStore: { updateHotel },
  } = stores;
  ...
  return (
    <HotelForm
      isEdit={true}
      initialValues={generateHotelInitialValues(hotel)}
